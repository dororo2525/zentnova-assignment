<script>
    ! function(a) {
        ...
        function n(e) {
            document.getElementById("header-lang-img") && ("en" == e ? document.getElementById("header-lang-img").src = "assets/skote/images/flags/us.jpg" : "sp" == e ? document.getElementById("header-lang-img").src = "{{ asset('assets/skote/images/flags/spain.jpg') }}" : "gr" == e ? document.getElementById("header-lang-img").src = "{{ asset('assets/skote/images/flags/germany.jpg') }}" : "it" == e ? document.getElementById("header-lang-img").src = "{{ asset('assets/skote/images/flags/italy.jpg') }}" : "ru" == e && (document.getElementById("header-lang-img").src = "{{ asset('assets/skote/images/flags/russia.jpg') }}"), localStorage.setItem("language", e), null == (t = localStorage.getItem("language")) && n(s), a.getJSON("assets/skote/lang/" + t + ".json", function(e) {
        ...
        function r(e) {
            1 == a("#light-mode-switch").prop("checked") && "light-mode-switch" === e ? (a("html").removeAttr("dir"), a("#dark-mode-switch").prop("checked", !1), a("#rtl-mode-switch").prop("checked", !1), a("#dark-rtl-mode-switch").prop("checked", !1), a("#bootstrap-style").attr("href", "{{ asset('assets/skote/css/bootstrap.min.css') }}"), a("body").attr("data-layout-mode", "light"), a("#app-style").attr("href", "{{ asset('assets/skote/css/app.min.css') }}"), sessionStorage.setItem("is_visited", "light-mode-switch")) : 1 == a("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e ? (a("html").removeAttr("dir"), a("#light-mode-switch").prop("checked", !1), a("#rtl-mode-switch").prop("checked", !1), a("#dark-rtl-mode-switch").prop("checked", !1), a("body").attr("data-layout-mode", "dark"), sessionStorage.setItem("is_visited", "dark-mode-switch")) : 1 == a("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e ? (a("#light-mode-switch").prop("checked", !1), a("#dark-mode-switch").prop("checked", !1), a("#dark-rtl-mode-switch").prop("checked", !1), a("#bootstrap-style").attr("href", "{{ asset('assets/skote/css/bootstrap-rtl.min.css') }}"), a("#app-style").attr("href", "{{ asset('assets/skote/css/app-rtl.min.css') }}"), a("html").attr("dir", "rtl"), a("body").attr("data-layout-mode", "light"), sessionStorage.setItem("is_visited", "rtl-mode-switch")) : 1 == a("#dark-rtl-mode-switch").prop("checked") && "dark-rtl-mode-switch" === e && (a("#light-mode-switch").prop("checked", !1), a("#rtl-mode-switch").prop("checked", !1), a("#dark-mode-switch").prop("checked", !1), a("#bootstrap-style").attr("href", "{{ asset('assets/skote/css/bootstrap-rtl.min.css') }}"), a("#app-style").attr("href", "{{ asset('assets/skote/css/app-rtl.min.css') }}"), a("html").attr("dir", "rtl"), a("body").attr("data-layout-mode", "dark"), sessionStorage.setItem("is_visited", "dark-rtl-mode-switch"))
        }
